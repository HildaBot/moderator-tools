...
public class ClearCommand extends ChannelCommand {
    ...
    public void execute(final Message message, final String[] args, final String label) {
        ...
        message.delete().reason("I automatically delete some command invocations.").queue(m -> this.hilda.getExecutor().execute(new ChannelClearTask(message.getTextChannel(), amount, user)));
    }
